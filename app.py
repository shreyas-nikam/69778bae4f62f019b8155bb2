...
st.set_page_config(page_title="QuLab: Lab 14: Production Hardening & Governance", layout="wide")
...
# --- Main Content Area ---
st.markdown(f"## 🛡️ LLM Quality Assurance with Automated Evaluation for PE Org-AI-R")
